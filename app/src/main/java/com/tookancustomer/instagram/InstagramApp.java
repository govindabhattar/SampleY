...
/**
 * Created by Ashutosh Ojha on 9/7/18.
 */
public class InstagramApp {

    private transient InstagramSession mSession;
    private transient OAuthAuthenticationListener mListener;
    ...
    MyAlertDialogFragment alertdFragment;
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        MyAlertDialogFragment.OAuthDialogListener listener1 = new MyAlertDialogFragment.OAuthDialogListener() {
            @Override
        ...
        alertdFragment = new MyAlertDialogFragment(mCtx, mAuthUrl, listener1);
...
//                    ex.printStackTrace();
    ...
    public void authorize() {
        ...
        //TODO
//        MyAlertDialogFragment alertdFragment = new MyAlertDialogFragment(mCtx,mAuthUrl,mListener);
        SplashActivity activity = (SplashActivity) mCtx;
        alertdFragment.show(activity.getFragmentManager(), "Alert Dialog Fragment");
