...
//        tvHeading.setText(StorefrontCommonData.getTerminology().getCheckoutTemplate());
        tvHeading.setText(getIntent().getStringExtra("agentName"));
        ...
        for (int i = 0; i < templateDataList.size(); i++) {
            ...
            switch (template.getDataType()) {
                ...
                case CustomViewsConstants.TEXT:
                    ...
                    CustomFieldTextViewAgentDetail editTextFreelancer = new CustomFieldTextViewAgentDetail(mActivity, isForDisplay);
