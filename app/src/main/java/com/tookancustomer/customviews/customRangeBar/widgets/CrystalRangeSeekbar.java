package com.tookancustomer.customviews.customRangeBar.widgets;
...
import com.tookancustomer.customviews.customRangeBar.interfaces.OnRangeSeekbarFinalValueListener;
...
public class CrystalRangeSeekbar extends View {
    ...
    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.CrystalRangeSeekbar_bar_highlight_color_mode, ColorMode.GRADIENT);
    }
