...
public class CustomFieldImageDelivery implements Item.Listener, View.OnClickListener {
    ...
    private final String TAG = CustomFieldImageDelivery.class.getSimpleName();
    ...
    public View render(Item item) {
        ...
        if (!item.getData().toString().isEmpty() && item.getData() instanceof ArrayList) {
          ...
          //  llImages.setVisibility(View.VISIBLE);
            ...
            rvAddedImages.setAdapter(customFieldImageAdapter = new CustomFieldImagesAdapterDelivery(activity, imagesList, item));
        }
