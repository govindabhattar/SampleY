...
public class CustomFieldCheckbox implements CustomField.Listener, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public View render(CustomField item) {
        ...
        switch (item.getDataType()) {
            ...
            case Keys.DataType.DROP_DOWN:
                ...
                List<String> dropdownList = item.getAllowedValues();
                ...
                if (dropdownList != null) {
                    ...
                    for (int position = 0; position < size; position++) {
                        String value = dropdownList.get(position);
...
//                        vCustomFieldIcon.setRotation(180);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        item.setData(position == 0 ? "" : item.getAllowedValues().get(position - 1));
