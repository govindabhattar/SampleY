...
public class DateRangeCalendarView extends LinearLayout {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        ((TextView) mainView.findViewById(R.id.tvDay1)).setText(StorefrontCommonData.getString(mContext, R.string.sun));
        ((TextView) mainView.findViewById(R.id.tvDay2)).setText(StorefrontCommonData.getString(mContext, R.string.mon));
        ((TextView) mainView.findViewById(R.id.tvDay3)).setText(StorefrontCommonData.getString(mContext, R.string.tue));
        ((TextView) mainView.findViewById(R.id.tvDay4)).setText(StorefrontCommonData.getString(mContext, R.string.wed));
        ((TextView) mainView.findViewById(R.id.tvDay5)).setText(StorefrontCommonData.getString(mContext, R.string.thu));
        ((TextView) mainView.findViewById(R.id.tvDay6)).setText(StorefrontCommonData.getString(mContext, R.string.fri));
        ((TextView) mainView.findViewById(R.id.tvDay7)).setText(StorefrontCommonData.getString(mContext, R.string.sat));
...
//            drawCalendarForMonth(currentCalendarMonth);
            ...
            if (minSelectedDate != null && maxSelectedDate == null) {
                ...
                drawSelectedDateRange(minSelectedDate, maxSelectedDate, false);
            ...
            if (shouldEnabledTime) {
                AwesomeTimePickerDialog awesomeTimePickerDialog = new AwesomeTimePickerDialog(mContext, StorefrontCommonData.getString(mContext, R.string.select_time), new AwesomeTimePickerDialog.TimePickerCallback() {
                    @Override
...
//        tvYearTitle.setTextColor(titleColor);
     ...
     * @param container - Container
     */
    public void disableDayContainer(DayContainer container) {
        container.tvDate.setBackgroundColor(Color.TRANSPARENT);
        container.strip.setBackgroundColor(Color.TRANSPARENT);
        container.rootView.setBackgroundColor(Color.TRANSPARENT);
     ...
     */
    public void drawSelectedDateRange(Calendar startDate, Calendar lastDate, final boolean isSelectedFromHome) {
