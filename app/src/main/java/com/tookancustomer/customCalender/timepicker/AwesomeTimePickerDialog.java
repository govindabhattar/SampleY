package com.tookancustomer.customCalender.timepicker;
...
import com.tookancustomer.customCalender.customviews.CustomTextView;
...
public class AwesomeTimePickerDialog extends Dialog {
    ...
    private void initView() {
        ...
        tvDialogDone.setText(StorefrontCommonData.getString(mContext,R.string.done));
        tvDialogCancel = (CustomTextView) findViewById(R.id.tvHeaderCancel);
        tvDialogCancel.setText(StorefrontCommonData.getString(mContext,R.string.cancel));
