...
import com.tookancustomer.adapter.ViewImagesAdapterDelivery;
 ...
 * Dated: 23/07/15.
 */
public class ViewImagesDialogDelivery {

    private static final String TAG = ViewImagesDialogDelivery.class.getSimpleName();
    ...
    private ViewImagesAdapterDelivery viewImagesAdapter;
     ...
     * @return
     */
    private ViewImagesDialogDelivery init() {
        ...
        try {
            ...
            vpImages.setAdapter(viewImagesAdapter = new ViewImagesAdapterDelivery(activity, imagesList));
...
//                        ex.printStackTrace();
    ...
    public static class Builder {
        ...
        private ViewImagesDialogDelivery viewImagesDialog = new ViewImagesDialogDelivery();
         ...
         * @return
         */
        public ViewImagesDialogDelivery build() {
        ...
        new OptionsDialog.Builder(activity)
                ...
                .listener(new OptionsDialog.Listener() {
                    ...
                    public void performPositiveAction(int purpose, Bundle backpack) {
                        ...
                        checkOutActivity.deleteCustomFieldImageDelivery(position);
                    }
