...
import com.tookancustomer.adapter.ViewImagesAdapterPickup;
 ...
 * Dated: 23/07/15.
 */
public class ViewImagesDialogPickup {

    private static final String TAG = ViewImagesDialogPickup.class.getSimpleName();
    ...
    private ViewImagesAdapterPickup viewImagesAdapter;
     ...
     * @return
     */
    private ViewImagesDialogPickup init() {
        ...
        try {
            ...
            vpImages.setAdapter(viewImagesAdapter = new ViewImagesAdapterPickup(activity, imagesList));
...
//                        ex.printStackTrace();
    ...
    public static class Builder {
        ...
        private ViewImagesDialogPickup viewImagesDialog = new ViewImagesDialogPickup();
         ...
         * @return
         */
        public ViewImagesDialogPickup build() {
