 ...
 * Dated: 23/07/15.
 */
public class ViewImagesDialogSignup {

    private static final String TAG = ViewImagesDialogSignup.class.getSimpleName();
     ...
     * @return
     */
    private ViewImagesDialogSignup init() {
...
//                        ex.printStackTrace();
    ...
    public static class Builder {
        ...
        private ViewImagesDialogSignup viewImagesDialog = new ViewImagesDialogSignup();
         ...
         * @return
         */
        public ViewImagesDialogSignup build() {
