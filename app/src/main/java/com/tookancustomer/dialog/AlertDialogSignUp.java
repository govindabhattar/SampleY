...
public class AlertDialogSignUp {
     ...
     * @return
     */
    private AlertDialogSignUp init() {
        try {
            alertDialog = new Dialog(activity, android.R.style.Theme_Translucent_NoTitleBar);
            alertDialog.setContentView(R.layout.dialog_alert_sign_up);
...
//            TextView tvMessage1 = (TextView) alertDialog.findViewById(R.id.tvMessage1);
...
//            tvMessage1.setText(Html.fromHtml(message));
            tvMessage.setTypeface(Font.getRegular(activity));
//            tvMessage1.setTypeface(Font.getRegular(activity));
//            btnAction.setText(actionButton);
            btnAction.setText(StorefrontCommonData.getString(activity, R.string.close));
            btnAction.setTypeface(Font.getRegular(activity));
...
//                        ex.printStackTrace();
    ...
    public static class Builder extends AlertDialogSignUp {
        private AlertDialogSignUp alertDialog = new AlertDialogSignUp();
        ...
        public AlertDialogSignUp build() {
            ...
            alertDialog.actionButton = Utils.assign(alertDialog.actionButton, getString(R.string.ok_text));
