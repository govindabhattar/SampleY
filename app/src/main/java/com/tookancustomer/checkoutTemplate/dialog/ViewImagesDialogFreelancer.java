...
public class ViewImagesDialogFreelancer {
    ...
    private static final String TAG = ViewImagesDialogFreelancer.class.getSimpleName();
     ...
     * @return
     */
    private ViewImagesDialogFreelancer init(boolean isForDisplay) {
        ...
        try {
            ...
            vpImages = mDialog.findViewById(R.id.vpImages);
    ...
    private void inflateIndicators(int position) {
        ...
        tvTitle.setText((position + 1) + " " + activity.getString(R.string.of) + " " + imagesList.size());
    }
...
//                        ex.printStackTrace();
    ...
    public static class Builder {
        ...
        private ViewImagesDialogFreelancer viewImagesDialog = new ViewImagesDialogFreelancer();
        private boolean isForDisplay;
        ...
        public Builder isForDisplay(boolean isForDisplay) {
            this.isForDisplay = isForDisplay;
            return this;
        }
        ...
        public ViewImagesDialogFreelancer build() {
            ...
            viewImagesDialog.title = Utils.assign(viewImagesDialog.title,
                    viewImagesDialog.activity.getString(R.string.view_images_text));

            return viewImagesDialog.init(isForDisplay);
        }
    ...
    public void checkDeleteStatus(final int position) {
        ...
        new OptionsDialog.Builder(activity)
                .message(R.string.delete_this_image_text)
                .listener(new OptionsDialog.Listener() {
                    ...
                    public void performPositiveAction(int purpose, Bundle backpack) {
                        ...
                        if (activity instanceof CheckoutTemplateActivity)
                            ((CheckoutTemplateActivity) activity).deleteCustomFieldImageSignup(position);
                        else if (activity instanceof CheckOutCustomActivity)
                            ((CheckOutCustomActivity) activity).deleteCustomFieldImageSignup(position);
                    }
