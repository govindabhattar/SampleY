...
import com.tookancustomer.checkoutTemplate.adapter.CustomFieldImagesAdapterFreelancer;
...
public class CustomFieldImageCheckout implements SignupTemplateData.Listener, View.OnClickListener {

    private final String TAG = CustomFieldImageCheckout.class.getSimpleName();
    ...
    private CustomFieldImagesAdapterFreelancer customFieldImageAdapter;
    View vwTop, vwBottom;
     ...
     */
    public CustomFieldImageCheckout(Context context, boolean isViewBottomHide, boolean isForDisplay) {
    ...
    public View render(Template item) {
        ...
        if (!item.getValue().toString().isEmpty() && item.getValue() instanceof ArrayList) {
            ...
            rvAddedImages.setAdapter(customFieldImageAdapter = new CustomFieldImagesAdapterFreelancer(activity, imagesList, item, isForDisplay));
        }
...
//                vSeperator.setVisibility(View.GONE);
                ...
                if (customFieldImageAdapter != null) {
                    ...
                    rvAddedImages.setAdapter(customFieldImageAdapter = new CustomFieldImagesAdapterFreelancer(activity, imagesList,
                            item, isForDisplay));
                }
