 ...
 * @param <T>
 */
public abstract class ResponseResolver_<T extends BaseResponse> implements Callback<T> {
     ...
     * @param activity
     */
    public ResponseResolver_(Activity activity) {
        this.weakActivity = new WeakReference<>(activity);
        this.showError = true;
    }

    public ResponseResolver_() {
    }
     ...
     * @param showLoading
     */
    public ResponseResolver_(Activity activity, Boolean showLoading) {
        this.weakActivity = new WeakReference<>(activity);
     ...
     * @param showError
     */
    public ResponseResolver_(Activity activity, Boolean showLoading, Boolean showError) {
        this.weakActivity = new WeakReference<>(activity);
        this.showLoading = showLoading;
...
//        }
    ...
    private void resolve(Call<T> t, Response<T> tResponse) {
        if (tResponse.isSuccessful() && tResponse.body() != null) {
            ...
            BaseResponse baseModel = tResponse.body();
