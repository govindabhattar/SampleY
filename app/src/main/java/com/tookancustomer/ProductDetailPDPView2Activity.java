...
import com.tookancustomer.customviews.CustomFieldTVMultiPDP;
...
import com.tookancustomer.fragments.DescriptionFragment;
import com.tookancustomer.fragments.PDPPhotosFragment;
...
public class ProductDetailPDPView2Activity extends BaseActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, OnMapReadyCallback {
    ...
    private TextView tvProductName, tvSubTotal, tvMerchantName, tvAddress, tvOutOfStockText;
    ...
    private LinearLayout llPDPCustomFieldsAmenities, llPDPCustomFieldView, llAdditionDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_detail_view_2);
        mActivity = this;
    ...
    private void setPDPView() {
        rlPDPView2.setVisibility(View.VISIBLE);
        pager = rlPDPView2.findViewById(R.id.pager);
        ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());

        // Add Fragments to adapter one by one
        adapter.addFragment(new DescriptionFragment(data.getDescription().toString()), getStrings(R.string.description));
        adapter.addFragment(new PDPPhotosFragment(data.getMultiImageUrl()), getStrings(R.string.photos));
//        adapter.addFragment(new DescriptionFragment(data.getDescription().toString()), "Offers");
        pager.setAdapter(adapter);

        tabLayout = rlPDPView2.findViewById(R.id.tabs);
     ...
     */
    private void init() {
        rlPDPView2 = findViewById(R.id.rlPDPView2);
        ((TextView) rlPDPView2.findViewById(R.id.tvProductDetails)).setText(getStrings(R.string.product_detail));
        ((TextView) rlPDPView2.findViewById(R.id.tvCall)).setText(getStrings(R.string.call));
        ((TextView) rlPDPView2.findViewById(R.id.tvLocate)).setText(getStrings(R.string.locate));
        ((TextView) rlPDPView2.findViewById(R.id.tvChat)).setText(getStrings(R.string.chat));
        ((TextView) rlPDPView2.findViewById(R.id.tvAdditionalDetails)).setText(getStrings(R.string.additional_detail));
        ((TextView) rlPDPView2.findViewById(R.id.tvProceed)).setText(getStrings(R.string.book_now));

        linearLayoutQuantitySelector = rlPDPView2.findViewById(R.id.linearLayoutQuantitySelector);
        tvSingleSelectionButton = rlPDPView2.findViewById(R.id.tvSingleSelectionButton);
        ivForwardArrowButton = rlPDPView2.findViewById(R.id.ivForwardArrowButton);
        textViewQuantity = rlPDPView2.findViewById(R.id.textViewQuantity);
        rlAddItem = rlPDPView2.findViewById(R.id.rlAddItem);
        rlRemoveItem = rlPDPView2.findViewById(R.id.rlRemoveItem);
        rlTotalQuantity = rlPDPView2.findViewById(R.id.rlTotalQuantity);
        tvTotalQuantity = rlPDPView2.findViewById(R.id.tvTotalQuantity);
        tvSubTotal = rlPDPView2.findViewById(R.id.tvSubTotal);
        tvMinOrderAmount = rlPDPView2.findViewById(R.id.tvMinOrderAmount);
        tvProductName = rlPDPView2.findViewById(R.id.tvProductName);
        ivBack = rlPDPView2.findViewById(R.id.ivBack);
        tvHeading = rlPDPView2.findViewById(R.id.tvHeading);

        tvSubTotal = rlPDPView2.findViewById(R.id.tvSubTotal);
        tvMerchantName = rlPDPView2.findViewById(R.id.tvMerchantName);
        tvAddress = rlPDPView2.findViewById(R.id.tvAddress);
        tvOutOfStockText = rlPDPView2.findViewById(R.id.tvOutOfStockText);
        rlTotalQuantity = rlPDPView2.findViewById(R.id.rlTotalQuantity);
        vpProductImage = rlPDPView2.findViewById(R.id.vpProductImage);
        llIndicators = rlPDPView2.findViewById(R.id.llIndicators);
        appbarLayout = rlPDPView2.findViewById(R.id.appbarLayout);
        collapsingToolbar = rlPDPView2.findViewById(R.id.collapsingToolbar);
        nsvScrollBar = rlPDPView2.findViewById(R.id.nsvScrollBar);
        clParentLayout = rlPDPView2.findViewById(R.id.clParentLayout);
        tvViewProfile = rlPDPView2.findViewById(R.id.tvViewProfile);
        tvViewProfile.setText(getStrings(R.string.view_profile));
        tvProceed = rlPDPView2.findViewById(R.id.tvProceed);
        tvPrice = rlPDPView2.findViewById(R.id.tvPrice);

        llPDPCustomFieldView = rlPDPView2.findViewById(R.id.llPDPCustomFieldView);

        llPDPCustomFieldsAmenities = rlPDPView2.findViewById(R.id.llPDPCustomFieldsAmenities);
        llPriceAddRemove = rlPDPView2.findViewById(R.id.llPriceAddRemove);
        llAdditionDetails = rlPDPView2.findViewById(R.id.llAdditionDetails);
        llPriceAddRemove.setVisibility(View.GONE);

        /**
         * For Rate and Review layout
         */
        llRateReviewTopLayout = rlPDPView2.findViewById(R.id.llRateReviewTopLayout);
        tvRatingsReviewsHeading = rlPDPView2.findViewById(R.id.tvRatingsReviewsHeading);
        tvRatingsReviewsHeading.setText(getStrings(R.string.reviews_ratings));
        llEditMerchantRatings = rlPDPView2.findViewById(R.id.llEditMerchantRatings);
        ((TextView) rlPDPView2.findViewById(R.id.tvReviewedThisPlace)).setText(getStrings(R.string.you_reviewed_this_place));
        tvSelfRating = rlPDPView2.findViewById(R.id.tvSelfRating);
        llSelfRatingLayout = rlPDPView2.findViewById(R.id.llSelfRatingLayout);
        tvEditReview = rlPDPView2.findViewById(R.id.tvEditReview);
        tvEditReview.setText(getStrings(R.string.edit_review));

        llAverageMerchantRatings = rlPDPView2.findViewById(R.id.llAverageMerchantRatings);
        llAverageRating = rlPDPView2.findViewById(R.id.llAverageRating);
        llAverageRatingStar = rlPDPView2.findViewById(R.id.llAverageRatingStar);
        llAverageRatingLayout = rlPDPView2.findViewById(R.id.llAverageRatingLayout);
        tvAverageRating = rlPDPView2.findViewById(R.id.tvAverageRating);
        tvTotalRateReviews = rlPDPView2.findViewById(R.id.tvTotalRateReviews);
        tvRateMerchantText = rlPDPView2.findViewById(R.id.tvRateMerchantText);
        llRateMerchantEmpty = rlPDPView2.findViewById(R.id.llRateMerchantEmpty);
        llGoToWriteReview = rlPDPView2.findViewById(R.id.llGoToWriteReview);

        tvSeeAllReviews = rlPDPView2.findViewById(R.id.tvSeeAllReviews);
        tvSeeAllReviews.setText(getStrings(R.string.see_all_reviews));

        rvReviewsList = rlPDPView2.findViewById(R.id.rvReviewsList);
        ...
        Utils.setOnClickListener(this, rlTotalQuantity, rlPDPView2.findViewById(R.id.rlBack),
                rlAddItem, rlRemoveItem, tvSingleSelectionButton, tvProceed, tvPrice,
                rlPDPView2.findViewById(R.id.llCall), rlPDPView2.findViewById(R.id.llLocateUs2),
                rlPDPView2.findViewById(R.id.llContactUs2), tvViewProfile, tvEditReview, tvSeeAllReviews);
        ...
        if (data != null) {
            if (data.getLayoutData() != null) {
                ...
                if (data.getStorefrontData().getBusinessType() == Constants.BusinessType.SERVICES_BUSINESS_TYPE && Constants.ProductsUnitType.getUnitType(data.getUnitType()) != Constants.ProductsUnitType.FIXED) {
                    tvPrice.setText(Utils.getCurrencySymbol() + Utils.getDoubleTwoDigits(data.getPrice().doubleValue()) + " " + getStrings(R.string.per) + " " +
                            Constants.ProductsUnitType.getUnitTypeText(mActivity, data.getUnit().intValue(), data.getUnitType(), false));
                } else {
                    tvPrice.setText(Utils.getCurrencySymbol() + Utils.getDoubleTwoDigits(data.getPrice().doubleValue()) + "");
                }
...
//            if (data.getMultiImageUrl() != null) {
            ...
            vpProductImage.setAdapter(new ViewImagesPDPAdapter(ProductDetailPDPView2Activity.this, data.getMultiImageUrl()));
...
//            tvHeading.setText(data.getName());
     ...
     */
    private void renderCustomFieldsPDPView2() {
        llPDPCustomFieldsAmenities.removeAllViews();
        llPDPCustomFieldView.removeAllViews();

        if (data.getCustomFields() == null) {
            return;
        }
        ArrayList<CustomField> amenitiesCustomFieldArrayList = new ArrayList<>();
        ArrayList<CustomField> otherCustomFieldArrayList = new ArrayList<>();
        for (int i = 0; i < data.getCustomFields().size(); i++) {
            if (data.getCustomFields().get(i).getDataType().equals(Keys.DataType.MULTI_SELECT)) {
                amenitiesCustomFieldArrayList.add(data.getCustomFields().get(i));
            } else {
                otherCustomFieldArrayList.add(data.getCustomFields().get(i));
            }
        }

        if (amenitiesCustomFieldArrayList.size() > 0) {
            View mView = new CustomFieldTVMultiPDP(this).render(amenitiesCustomFieldArrayList);
            if (mView != null) {
                llPDPCustomFieldsAmenities.addView(mView);
            }
        }

        if (otherCustomFieldArrayList.size() > 0) {
            llAdditionDetails.setVisibility(View.VISIBLE);

            for (CustomField item : otherCustomFieldArrayList) {
                View view1 = null;
                switch (item.getDataType()) {
                    case Keys.DataType.TEXT_AREA:
                        view1 = new CustomFieldTextViewPDP(this, item.getDataType()).render(mActivity, item);
                        break;
                ...
                if (view1 != null) {
                    llPDPCustomFieldView.addView(view1);
                }
            }

        } else {
            llAdditionDetails.setVisibility(View.GONE);
        }
    }
...
//        sb.setSpan((Font.getSemiBold(getActivity())), checkoutString.indexOf(getString(R.string.checkout)), (getString(R.string.checkout).length()), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE); //bold
        sb.setSpan(new CustomTypefaceSpan("", Font.getSemiBold(ProductDetailPDPView2Activity.this)), checkoutString.indexOf(getStrings(R.string.view_cart)), ((getStrings(R.string.view_cart)).length()), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE); //bold
    ...
    private void addCartItem(int selectedQuantity) {
        if (data.getMaxProductquantity() == 0 || data.getSelectedQuantity() < data.getMaxProductquantity()) {
            ...
            if (data.getInventoryEnabled() == 0 || (data.getSelectedQuantity() < data.getAvailableQuantity() && data.getInventoryEnabled() == 1)) {
                ...
                Utils.showToast(ProductDetailPDPView2Activity.this, getStrings(R.string.order_quantity_limited));
            }
        } else {
...
//                        .title(data.getName()).position(0).build().show();
            ...
            case R.id.tvPrice:
                if (data.getCustomizeItem().size() > 0) {
                    ...
                    CustomizeIntent.putExtra(PICKUP_LATITUDE, pickupLatitude);
                    CustomizeIntent.putExtra(PICKUP_LONGITUDE, pickupLongitude);
            ...
            case R.id.rlTotalQuantity:
                if (Dependencies.getSelectedProductsArrayList().size() > 0 && Dependencies.getSelectedProductsArrayList().get(0).getStorefrontData() != null) {
                    if (Dependencies.getSelectedProductsArrayList().get(0).getStorefrontData().getMerchantMinimumOrder() > Dependencies.getProductListSubtotal()) {
                        Utils.snackBar(mActivity, getStrings(R.string.minimum) + " " + Utils.getCallTaskAs(true, false) + " " + getStrings(R.string.minimum_order_amount_is) + " " + Utils.getCurrencySymbol() + Utils.getDoubleTwoDigits(Dependencies.getSelectedProductsArrayList().get(0).getStorefrontData().getMerchantMinimumOrder().intValue()));
                        return;
                    }
                } else {
                    if (data.getStorefrontData().getMerchantMinimumOrder() > Dependencies.getProductListSubtotal()) {
                        Utils.snackBar(mActivity, getStrings(R.string.minimum) + " " + Utils.getCallTaskAs(true, false) + " " + getStrings(R.string.minimum_order_amount_is) + " " + Utils.getCurrencySymbol() + Utils.getDoubleTwoDigits(data.getStorefrontData().getMerchantMinimumOrder().intValue()));
                        return;
                    }
                }
