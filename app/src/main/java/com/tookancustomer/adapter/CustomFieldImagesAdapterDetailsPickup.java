 ...
 * Dated: 22/07/15.
 */
public class CustomFieldImagesAdapterDetailsPickup extends RecyclerView.Adapter<CustomFieldImagesAdapterDetailsPickup.ViewHolder> {

    private Context context;
    private Activity activity;
    private ArrayList<String> imagesList;

    public CustomFieldImagesAdapterDetailsPickup(Activity activity, @NonNull ArrayList<String> imagesList) {
