 ...
 * Dated: 22/07/15.
 */
public class CustomFieldImagesAdapterDetailsDelivery extends RecyclerView.Adapter<CustomFieldImagesAdapterDetailsDelivery.ViewHolder> {

    private Context context;
    private Activity activity;
    private ArrayList<String> imagesList;

    public CustomFieldImagesAdapterDetailsDelivery(Activity activity, @NonNull ArrayList<String> imagesList) {
