 ...
 * Dated: 22/07/15.
 */
public class CustomFieldImagesAdapterDelivery extends RecyclerView.Adapter<CustomFieldImagesAdapterDelivery.ViewHolder> {
    ...
    public CustomFieldImagesAdapterDelivery(CheckOutActivityOld activity, @NonNull ArrayList<String> imagesList, Item item) {
    ...
    private void viewImages(int position) {
        ...
        new ViewImagesDialogDelivery.Builder(activity)
