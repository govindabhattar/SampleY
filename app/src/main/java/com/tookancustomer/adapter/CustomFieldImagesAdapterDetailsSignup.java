 ...
 * Dated: 22/07/15.
 */
public class CustomFieldImagesAdapterDetailsSignup extends RecyclerView.Adapter<CustomFieldImagesAdapterDetailsSignup.ViewHolder> {

    private Context context;
    private Activity activity;
    private ArrayList<String> imagesList;

    public CustomFieldImagesAdapterDetailsSignup(Activity activity, @NonNull ArrayList<String> imagesList) {
